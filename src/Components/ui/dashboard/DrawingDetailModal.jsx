...
export default function DrawingDetailModal({ drawing, onClose }) {
  ...
  useEffect(() => {
    const loadUser = async () => {
      try {
        ...
        setUser(userData);
        // Vérifier si l'utilisateur a déjà voté (stocké localement)
  ...
  const voteMutation = useMutation({
    mutationFn: async () => {
      const newVotes = hasVoted ? drawing.votes - 1 : drawing.votes + 1;
  ...
  const handleSocialShare = (platform) => {
    ...
    const urls = {
      ...
      instagram: imageUrl, // Instagram ne supporte pas le partage direct web
    };
        ...
        <div className="grid md:grid-cols-2">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <Heart className={`w-5 h-5 mr-2 ${hasVoted ? 'fill-rose-500 text-rose-500' : 'text-gray-400'}`} />
            ...
            <div className="space-y-3 pt-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button
                  className="bg-gradient-to-r from-rose-500 to-amber-500 hover:from-rose-600 hover:to-amber-600 text-white rounded-xl h-12"
                >
